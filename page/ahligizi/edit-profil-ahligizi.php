...
if (isset($_POST['simpan'])) {
    ...
    $query2 = "UPDATE `nutritionist` SET `email_nutritionist` = '$email', `fullname_nutritionist` = '$nama', `years_of_experience` = '$tahun', `education` = '$pendidikan', `certification` = '$sertifikasi', 'profile_picture_nutritionist' = $profil WHERE `id_nutritionist` = $id";
    ...
    if ($row > 0) {
      ...
      alert('Data berhasil diubah...');
        ...
        header("location: profil-ahligizi.php");
    } else {
        echo "<script>
