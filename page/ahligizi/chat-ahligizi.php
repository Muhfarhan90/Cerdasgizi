...
// Mendapatkan data ahli gizi
$id_user = $_SESSION['id_user'];
$query_nutritionist = "SELECT * FROM nutritionist WHERE id_user = $id_user";
$result_nutritionist = mysqli_query($conn, $query_nutritionist);
$row_nutritionist = mysqli_fetch_assoc($result_nutritionist);
...
if (isset($_POST['kirim'])) {
    ...
    $query_insert = "INSERT INTO chat (id_consultation, id_patient, id_nutritionist, message, date_time_chat) VALUES ($id_konsultasi, $id_pasien, $id_ahligizi, '$message', '$tanggal')";
...
$query_chat = "SELECT chat.*, patient.fullname_patient AS patient_name, nutritionist.fullname_nutritionist AS nutritionist_name 
               FROM chat 
                        ...
                        <div class="col-md-6 col-lg-7 col-xl-12" style="margin-bottom: 4rem;">
                            <ul class="d-flex flex-column list-unstyled chat-container">
                                <?php while ($row_chat = mysqli_fetch_assoc($result_chat)) : ?>
                                    <?php if ($row_chat['ID_NUTRITIONIST'] == $id_ahligizi) : ?>
                                        <!-- Pesan dari pasien -->
