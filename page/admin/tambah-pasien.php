        ...
        <div class="content-wrapper">
          ...
          <div class="row">
            ...
            <div class="col-xl-6 grid-margin stretch-card flex-column">
              <h1 class="mb-2 text-titlecase mb-4">Tambah Data Pasien</h1>
            </div>
          </div>
            ...
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" method="POST" enctype="multipart/form-data" action="proses-tambah-pasien.php">
                    ...
                    <div class="form-group">
                      ...
                      <input type="date" class="form-control" id="exampleInputPassword4" name="tanggal_lahir">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control" id="exampleInputCity1" name="tinggi_badan" placeholder="Height">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputCity1">Berat Badan (Kg)</label>
                      <input type="number" class="form-control" id="exampleInputCity1" name="berat_badan" placeholder="Weight">
                    </div>
                    <button type="submit" class="btn btn-primary mr-2" name="tambah-pasien">Tambah</button>
