                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" action="" method="POST">
                    ...
                    <div class="form-group">
                      ...
                      <input disabled type="number" class="form-control" id="exampleInputEmail3" placeholder="hasil" name="hasil" value="<?= $hasil ?>" >
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail3">Kategori</label>
                      <input disabled type="text" class="form-control" id="exampleInputEmail3" placeholder="kategori" value="<?= $kategori ?>" >
                    </div>
                  </form>
                </div>
              </div>
